...
<body>
        ...
        <input type="number" id="durationInput" placeholder="Duration in seconds">
					...
					<tr class="text-right">
						<td colspan="5" style="font-size: 28px; font-weight: bold;">GELANGGANG :
							<?php echo $jadwal['gelanggang']; ?>
						</td>
					</tr>
					<tr class="text-right">
						<td colspan="5" style="font-size: 28px; font-weight: bold;">
							PARTAI :
							<?php echo $jadwal['partai'] . " (" . $jadwal['babak'] . ")"; ?>
						</td>
					</tr>
					<tr>
						<td colspan="6">
					...
					<tr class="text-center">
						<td colspan="5" style="font-size: 16px; font-weight: bold;">
							<p>
								<?php echo $jadwal['nm_merah']; ?>
							</p>
						</td>
						<td>&nbsp;</td>
						<td colspan="5" style="font-size: 16px; font-weight: bold;">
							<?php echo $jadwal['nm_biru']; ?>
						</td>
					</tr>
					<tr class="text-center">
						<td colspan="5" style="font-size: 16px; font-weight: bold;">
							<p>
								<?php echo $jadwal['kontingen_merah']; ?>
							</p>
						</td>
						<td>&nbsp;</td>
						<td colspan="5" style="font-size: 16px; font-weight: bold;">
							<p>
								<?php echo $jadwal['kontingen_biru']; ?>
							</p>
						</td>
					</tr>
					<tr class="text-center">
						<td colspan="5" bgcolor="#FF0000" style="font-size: 16px; font-weight: bold;">
							<font color="white">SUDUT MERAH</font>
						</td>
						<td bgcolor="#F5F5F5">&nbsp;</td>
						<td colspan="5" bgcolor="#1E90FF" style="font-size: 16px; font-weight: bold;">
							<font color="white">SUDUT BIRU</font>
						</td>
					</tr>
				...
				<tbody class="content_penilaian">
					<tr class="text-center" style="font-size: 24px;">
						<td>
							<?php echo $nilaijuri1babak1merah[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri2babak1merah[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri3babak1merah[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri4babak1merah[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri5babak1merah[0]; ?>
						</td>
						<td bgcolor="#F5F5F5">I</td>
						<td>
							<?php echo $nilaijuri1babak1biru[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri2babak1biru[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri3babak1biru[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri4babak1biru[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri5babak1biru[0]; ?>
						</td>
					</tr>
					<tr class="text-center" style="font-size: 24px;">
						<td>
							<?php echo $nilaijuri1babak2merah[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri2babak2merah[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri3babak2merah[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri4babak2merah[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri5babak2merah[0]; ?>
						</td>
						<td bgcolor="#F5F5F5">II</td>
						<td>
							<?php echo $nilaijuri1babak2biru[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri2babak2biru[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri3babak2biru[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri4babak2biru[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri5babak2biru[0]; ?>
						</td>
					</tr>
					<tr class="text-center" style="font-size: 24px;">
						<td>
							<?php echo $nilaijuri1babak3merah[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri2babak3merah[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri3babak3merah[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri4babak3merah[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri5babak3merah[0]; ?>
						</td>
						<td bgcolor="#F5F5F5">III</td>
						<td>
							<?php echo $nilaijuri1babak3biru[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri2babak3biru[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri3babak3biru[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri4babak3biru[0]; ?>
						</td>
						<td>
							<?php echo $nilaijuri5babak3biru[0]; ?>
						</td>
					</tr>
					<?php
		...
		<div class="table-responsive">
			<table class="table">
				<tr>
					...
					<td class="text-right">
						<form name="SetorNilai" id="SetorNilai" method="POST" action="setor_nilai.php"
							onclick="return cek_selesai();">
							<?php
  ...
  // Mengirimkan data waktu menggunakan AJAX ke sse.php pada server
  $.ajax({
    type: "POST",
    url: "../sse.php",
    data: JSON.stringify({ minutes: minutes, seconds: seconds }),
    success: function() {
      // Tidak perlu melakukan apa pun saat berhasil mengirimkan data
    },
    dataType: "json"
  });
};
